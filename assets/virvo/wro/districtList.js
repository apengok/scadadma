    ...
    dmaManage = {
        ...
        beforeRemove: function(treeId, treeNode){
            ...
            if(treeNode.type == "group"){
                // 增加组织是否存在dma分区的判断
                // if(treeNode.dma_no !== undefined && treeNode.dma_no !== null){
        ...
        addHoverDom: function(treeId, treeNode){
            var sgroupObj = $("#" + treeNode.tId + "_span");
            var sgroupEdit = $("#" + treeNode.tId + "_span");
            var sgroupDetails = $("#" + treeNode.tId + "_span");
            ...
            var addgroupStr = "<span class='button add' id='addgroupBtn_"
                    + treeNode.tId
                    + "' title='增加组织' href='/entm/user/group/add/?id="
                    + id
                    + "&pid="
                    + pid
                    + "' data-target='#commonWin' data-toggle='modal'></span>";
            var editgroupStr = "<span class='button edit' id='editgroupBtn_"
                    + treeNode.tId
                    + "' title='编辑组织' href='/entm/user/group/edit/"
                    + pid
                    + "/' data-target='#commonWin' data-toggle='modal'></span>";
            var detailsgroupStr = "<span class='button details' id='detailsgroupBtn_"
                    + treeNode.tId
                    + "' title='组织详情'  href='/entm/user/group/detail/"
                    + pid
                    + "/' data-target='#commonWin' data-toggle='modal'</span>";
            ...
            var addStr = "<span class='button add' id='addBtn_"
                    + treeNode.tId
                    + "' title='增加分区' href='/dmam/district/add/?id="
                    + id
                    + "&pid="
                    + pid
                    + "' data-target='#commonSmWin' data-toggle='modal' style='background-image:url(/static/virvo/images/adddma.png)'><img  src='/static/virvo/images/adddma.png' style='outline: none;'></span>";
            var editStr = "<span class='button edit' id='editBtn_"
                    + treeNode.tId
                    + "' title='编辑分区' href='/dmam/district/edit/"
                    + pid
            ...
            var detailsStr = "<span class='button details' id='detailsBtn_"
                    + treeNode.tId
                    + "' title='分区详情'  href='/dmam/district/detail/"
                    + pid
            ...
            if(treeNode.type == "group" && permission == "true"){
                sObj.after(addStr);
                sgroupEdit.after(editgroupStr);
                sgroupDetails.after(detailsgroupStr);
                sgroupObj.after(addgroupStr);
            }
            ...
            var groupbtn = $("#addgroupBtn_" + treeNode.tId);
            if (groupbtn)
            ...
            var editgroupBtn = $("#editgroupBtn_" + treeNode.tId);
            if(editgroupBtn)
            ...
            var detgroupBtn = $("#detailsgroupBtn_" + treeNode.tId);
        ...
        removeHoverDom: function(treeId, treeNode){
            ...
            $("#detailsgroupBtn_" + treeNode.tId).unbind().remove();
